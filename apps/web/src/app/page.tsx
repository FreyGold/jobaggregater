          ...
          <Container>
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mx-auto mt-12 max-w-2xl">
                <div className="rounded-3xl border border-primary/20 bg-card/95 p-4 shadow-xl ring-1 ring-primary/10 backdrop-blur-md transition-shadow hover:border-primary/40 hover:shadow-2xl">
                  <SearchBar size="lg" />
                </div>
              </div>
